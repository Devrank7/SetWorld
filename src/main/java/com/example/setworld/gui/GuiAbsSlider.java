...
public abstract class GuiAbsSlider extends AbstractWidget {
    ...
    public GuiAbsSlider(int p_93579_, int p_93580_, int p_93581_, int p_93582_, Component p_93583_, double p_93584_) {
    ...
    protected void setValueFromMouse(double p_93586_) {
