package com.example.setworld.tabs;
...
public class WorldsTab extends GridLayoutTab {
    ...
    private static final Component SUPER_LARGE_HELP_TEXT = Component.translatable("generator.setworld.super_large_biomes.info");
    ...
    private static final Logger log = LoggerFactory.getLogger(WorldsTab.class);
    ...
    public WorldsTab(CreateWorldScreen screen) {
        ...
        screen.getUiState().addListener(p_280909_ -> {
            ...
            } else if (((IEntryWorldType)(Object) worldcreationuistate$worldtypeentry).isSuperLarge()) {
                cyclebutton.setTooltip(Tooltip.create(SUPER_LARGE_HELP_TEXT));
            } else {
        ...
        screen.getUiState().addListener(p_280910_ -> {
            log.info("Is debug: {}", p_280910_.isDebug());
            log.info("Is preset editor: {}", p_280910_.getPresetEditor());
    ...
    private void openPresetEditor(CreateWorldScreen screen) {
        ...
        System.err.println(preseteditor);
