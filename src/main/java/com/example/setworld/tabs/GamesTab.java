...
public class GamesTab extends GridLayoutTab {
    ...
    public GamesTab(CreateWorldScreen screen) {
        ...
        CycleButton<Difficulty> cyclebutton1 = gridlayout$rowhelper.addChild(
                CycleButton.builder(Difficulty::getDisplayName)
                        ...
                        .create(
                                ...
                                (p_267962_, p_268338_) -> {
                                    screen.getUiState().setDifficulty(p_268338_);
        ...
        screen.getUiState().addListener(p_280905_ -> {
            cyclebutton1.setValue(screen.getUiState().getDifficulty());
            cyclebutton1.active = !screen.getUiState().isHardcore();
            Component component = screen.getUiState().getDifficulty().getInfo();
